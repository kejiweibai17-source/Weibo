    ...
    <>
      ...
      <section className="hero-container" ref={containerRef}>
        ...
        <div className="top-left-logo">
          <span className="logo-main">昔馬電動刮鬍刀</span>
          <span className="logo-sub"> SMASMALL</span>
        </div>

        <div className="bottom-left-text">
          <span className="underline">FLAGSHIP TRIPLE BLADE</span>
          <span>
            from <strong> by WEIBO</strong>
          </span>
        </div>
