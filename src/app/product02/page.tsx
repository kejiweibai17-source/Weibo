...
export default function Product01Page() {
  ...
  const schemaWebPage = {
    "@context": "https://schema.org",
    "@type": "ItemPage",
    "@id": `${SITE_URL}/product02/#webpage`,
    url: `${SITE_URL}/product02`,
    name: "昔馬 SMASMALL 捍衛者+ 全合金電動刮鬍刀｜戰損塗裝、磁吸快拆",
    description:
      "探索昔馬 SMASMALL 捍衛者+ 全合金戰損刮鬍刀。獨創硬派戰損塗裝，展現男士極致理容美學。",
    isPartOf: { "@id": ids.website },
    about: { "@id": `${SITE_URL}/product02/#product` },
    mainEntity: { "@id": `${SITE_URL}/product02/#product` },
    publisher: { "@id": ids.organization },
  };
